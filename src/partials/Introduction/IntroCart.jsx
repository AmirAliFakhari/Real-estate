function IntroCart({ img, title, text, buttonText }) {
  return (
    <div className="flex w-56 flex-col items-center justify-center gap-5 rounded-md border border-gray-600 bg-stone-50 p-6 text-center  drop-shadow-2xl md:w-[14rem] lg:w-[20rem]">
